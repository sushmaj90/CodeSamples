...
public class MainActivity extends AppCompatActivity implements
    ...
    public final static String EMAIL_PARAM = "package com.example.sushma.apt_finalandroid.EMAIL";
    public final static String USER_NAME = "package com.example.sushma.apt_finalandroid.USERNAME";
...
//        btnVerifyUser = (Button)findViewById(R.id.btnVerifyUser);
//        btnVerifyUser.setOnClickListener(new View.OnClickListener() {
//            public void onClick(View v) {
//                EditText edMail = (EditText) findViewById(R.id.profileUniEmail);
//                String uniEmail = edMail.getText().toString();
//                if(!uniEmail.isEmpty()) {
//                    final String request_url2 = "http://engineapp-1084.appspot.com/userVerification?univ_email=" + uniEmail + "&gmail_id=" + email;
...
//            public void onClick(View v) {
//                final String request_url1 = "http://engineapp-1084.appspot.com/isUserVerified?userID="+email;
...
//                            String userVerified = jObject.getString("userVerified");
//                            if(userVerified.equals("Y")){
...
//        mRevokeButton.setEnabled(true);
        ...
        final String request_url = "http://engineapp-1084.appspot.com/checkUserExists?userID="+email;
        ...
        httpClient.get(request_url, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] response) {
                try {
                    JSONObject jObject = new JSONObject(new String(response));
                    String userExists = jObject.getString("userExists");
